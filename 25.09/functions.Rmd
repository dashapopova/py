...
Let's take [the data on the UK pubs](https://raw.githubusercontent.com/dashapopova/Intro-to-R/main/HWs/HW2/UK_pubs.csv). Some of the pub names have *Inn* as part of them. Let's plot twenty most common pubs with *Inn* in their names and without *Inn* in their names. 
...
```{r}
uk_pubs <- read.csv("https://raw.githubusercontent.com/dashapopova/Intro-to-R/main/HWs/HW2/UK_pubs.csv")
uk_pubs %>% 
